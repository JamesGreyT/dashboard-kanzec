...
CATALOG: dict[str, TableDef] = {
    ...
    "payment": TableDef(
        ...
        columns={
            "payment_id":     ColumnDef("Payment ID", "int",  ("=", "in"), True, id_column=True),
            "payment_date":   ColumnDef("Date", "timestamp", ("=", ">=", "<=", ">", "<"), True),
            "person_id":      ColumnDef("Client ID", "int",  ("=", "in"), False, id_column=True),
            "client_name":    ColumnDef("Client", "text",    ("=", "ilike", "in"), True),
            "client_code":    ColumnDef("Client Code", "text", ("=", "ilike", "in"), True),
            "client_tin":     ColumnDef("TIN", "text",       ("=", "ilike", "in"), False),
            "contract":       ColumnDef("Contract", "text",  ("=", "ilike", "in"), False),
    ...
    "legal_person": TableDef(
        ...
        columns={
            ...
            "instalment_days":            ColumnDef("Instalment days", "int",     (">=", "<=", "=", ">", "<", "in"), True, numeric=True),
            "instalment_days_source":     ColumnDef("Instalment days source", "text", ("=", "in"), False),
            "instalment_days_updated_at": ColumnDef("Instalment days updated", "timestamp", ("=", ">=", "<=", ">", "<"), False),
            "client_group":               ColumnDef("Group", "text",              ("=", "in"), True),
            "client_group_source":        ColumnDef("Group source", "text",       ("=", "in"), False),
            "client_group_updated_at":    ColumnDef("Group updated", "timestamp", ("=", ">=", "<=", ">", "<"), False),
            "deal_deadline_start":        ColumnDef("Deal deadline start", "date", ("=", ">=", "<=", ">", "<"), False),
            "deal_monthly_amount":        ColumnDef("Monthly amount", "numeric",  (">=", "<=", "=", ">", "<"), False, numeric=True, currency="USD"),
            "deal_meta_updated_at":       ColumnDef("Deal meta updated", "timestamp", ("=", ">=", "<=", ">", "<"), False),
