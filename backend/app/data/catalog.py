...
CATALOG: dict[str, TableDef] = {
    ...
    "legal_person": TableDef(
        ...
        columns={
            ...
            "code":                 ColumnDef("Code", "text",        ("=", "ilike", "in"), True),
            "tin":                  ColumnDef("TIN", "text",         ("=", "ilike", "in"), True),
            "name":                 ColumnDef("Name", "text",        ("=", "ilike", "in"), True),
            "short_name":           ColumnDef("Short name", "text",  ("=", "ilike", "in"), False),
            "state_name":           ColumnDef("State", "text",       ("=", "in"), True),
            "person_as_name":       ColumnDef("Counterparty type", "text", ("=", "ilike", "in"), False),
            ...
            "region_name":          ColumnDef("Region", "text",      ("=", "ilike", "in"), False),
