...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        // Plex metrics — tighter natural spacing than Fraunces; only nudge
        // the largest headings.
        "heading-xl": ["3.5rem", { lineHeight: "1.05", letterSpacing: "-0.01em" }],
        "heading-lg": ["2.75rem", { lineHeight: "1.08", letterSpacing: "-0.008em" }],
        "heading-md": ["2rem", { lineHeight: "1.15" }],
        "heading-sm": ["1.25rem", { lineHeight: "1.3" }],
        "stat-xl": ["3rem", { lineHeight: "1", letterSpacing: "-0.012em" }],
        "stat-md": ["1.75rem", { lineHeight: "1.1" }],
        body: ["0.9375rem", { lineHeight: "1.55" }],
        label: ["0.8125rem", { lineHeight: "1.4" }],
        caption: ["0.75rem", { lineHeight: "1.4" }],
        eyebrow: ["0.6875rem", { lineHeight: "1", letterSpacing: "0.1em" }],
